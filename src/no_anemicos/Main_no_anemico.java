...
public class Main_no_anemico {
    public static void main(String[] args) {
        ...
        -----> Los metodos implementados utilizan el estado interno, es decir, aplican la lógica relacionada al objeto toda
                dentro del mismo objeto.
        -----> Es el mismo objeto el que conoce y maneja su propia lógica sobre su estado interno
